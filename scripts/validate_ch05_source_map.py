...
Verifies canonical 67-page Part 1 and 72-page Part 2, exclusions of variants,
SELF_STUDY status for page 56, and ensures Chapter 5 theory remains unauthored.
"""
...
def validate_ch05():
    print(">>> Validating Chapter 5 Canonical Source Map...")
    failures: list[str] = []
    ...
    if not d_p1:
        ...
        # Check page coverage continuity 1..67
        seen_p1_pages = []
        p56_found = False
    ...
    # Output Results
    if failures:
        print("FAIL: Chapter 5 canonical source map validation failed:")
        for f in failures:
            print(f"  - {f}")
        return False

    print("PASS: Chapter 5 canonical source map verified successfully:")
    print("  [OK] Canonical Part 1: #Week06-Chapter5-1 2024.pdf (67 pages, SHA matched)")
    print("  [OK] Canonical Part 2: #Week07-Chapter5-2 2024.pdf (72 pages, SHA matched)")
    print("  [OK] Canonical Coverage: Part 1 = 63 CONTENT + 4 NON_CONTENT; Part 2 = 68 CONTENT + 4 NON_CONTENT")
