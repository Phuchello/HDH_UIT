...
| NEG-05 forbidden workstation path | exit 1 | PASS | >>> Running Public Hygiene & Path Leak Audit... Scanned 135 tracked files.  ============================================================ PUBLIC HYGIENE AUDIT FAILED with 1 leaked paths:   - content/theory/ch01-overview.md:131 [Pattern: '<LO |
