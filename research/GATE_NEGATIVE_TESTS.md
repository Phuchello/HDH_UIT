...
|---|---:|:---:|---|
| NEG-01 duplicate source ID | exit 1 | PASS | >>> Validating Global Source Registry... Found 73 registered source IDs; verified 60 content references. SOURCE VALIDATION FAILED:   - Duplicate source ID in registry   - Source UIT-SLIDE-CH01-2024 missing title   - Source UIT-SLIDE-CH01-20 |
| NEG-02 unknown source reference | exit 1 | PASS | >>> Validating Global Source Registry... Found 72 registered source IDs; verified 59 content references. SOURCE VALIDATION FAILED:   - Unknown source ID 'NO-SUCH-SOURCE' in content/theory/ch01-overview.md |
| NEG-03 malformed source hash | exit 1 | PASS | >>> Validating Global Source Registry... Found 72 registered source IDs; verified 60 content references. SOURCE VALIDATION FAILED:   - VERIFIED_LOCAL source UIT-SLIDE-CH01-2024 has invalid sha256 |
...
| NEG-05 forbidden workstation path | exit 1 | PASS | >>> Running Public Hygiene & Path Leak Audit... Scanned 139 tracked files.  ============================================================ PUBLIC HYGIENE AUDIT FAILED with 1 leaked paths:   - content/theory/ch01-overview.md:131 [Pattern: '<LO |
...
| NEG-07 unsupported OFFICIAL_RUBRIC | exit 1 | PASS | >>> Validating Canonical Content & Exam Models... Discovered 15 unique canonical document IDs.  ============================================================ CONTENT VALIDATION FAILED with 1 errors:   - Unverified 'Barem chính thức' claim in |
