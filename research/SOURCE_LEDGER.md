...
| **A-07** | `Week06-Chapter4-3 2024.pdf` (46 slides) | Giảng viên IT007 UIT | 2024 | Slide | Định thời tiểu trình (PCS vs SCS), Đa bộ xử lý (Affinity, Load balancing: Push/Pull), Định thời Real-time, Linux CFS (`vruntime`, Red-Black tree), Windows Scheduler (32 priority levels). |
...
| **A-09** | `Week08-Midterm Review.pdf` (16 slides) | Khoa KTMT – UIT | 2024 | Slide Ôn tập | Khung ma trận ôn tập giữa kỳ: Bộ câu hỏi lý thuyết Ch1–Ch4, Bài tập trạng thái tiến trình, Cây `fork()`, Bài tập định thời CPU 5 tiến trình. |
