...
| **A-22** | `Bai tap chuong 7 HDH.docx` (20 đơn vị nguồn: 88 đoạn thân / 100 nút XML w:p) | Khoa KTMT – UIT | 2024 | Bộ bài tập chính thức | Bộ câu hỏi và bài tập Chương 7 chính thức đầy đủ 20 đơn vị nguồn (9 lý thuyết + 11 bài tập; 88 đoạn thân văn bản / 84 đoạn phi rỗng; 1 bảng 6x2 gồm 12 đoạn ô; 100 nút XML w:p / 96 phi rỗng), SHA-256 `5b03f4e0...` (`UIT-QBANK-CH07-2024`). |
| **A-22-VARIANT-DRIVE** | `Bai tap chuong 7 HDH.docx` (85 đoạn thân / 97 nút XML w:p) | Khoa KTMT – UIT | 2024 | Local source variant | Bản tải sớm từ Drive (SHA-256 `f8e523d1...`; 85 đoạn thân / 80 phi rỗng; 1 bảng 6x2 gồm 12 đoạn ô; 97 nút XML w:p / 92 phi rỗng), bị cắt ngắn tại câu hỏi số 18, thiếu bài tập 19 và 20 (`UIT-QBANK-CH07-2024-VARIANT-DRIVE-85P`). |
