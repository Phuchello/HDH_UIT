...
| :--- | :--- | :--- | :---: | :--- | :--- |
| **A-01** | `IT007_HeDieuHanh_14.2024.pdf` (19 trang) | Khoa Kỹ thuật Máy tính – UIT | 2024–2025 | Đề cương chính thức (Canonical Outline) | Đề cương chi tiết học phần IT007 Hệ điều hành năm học 2024–2025 (tạo ngày 2024-09-11). Quy định cấu trúc 9 chương, chuẩn đầu ra (CLO), thang điểm đánh giá. Phân phối Chương 6 tại Buổi 8 với bộ slide week 8: 6.1 Định nghĩa, 6.2 Mô hình hệ thống, 6.3 Phương pháp giải quyết deadlock (6.3.1 Prevention, 6.3.2 Avoidance, 6.3.3 Detection, 6.3.4 Recovery), 6.4 Bài tập. |
