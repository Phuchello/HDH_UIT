...
| **SQ04-03** | Ch 4 | `DEFINE` | Trình bày 5 tiêu chuẩn đánh giá hiệu năng định thời CPU: CPU Utilization, Throughput, Turnaround Time, Waiting Time, Response Time. Nêu mục tiêu tối ưu của từng tiêu chuẩn. | `SRC-A04` / `SRC-A10` | `Week08: Slide 13`, `GK 2018-2025` | 1.0đ | Easy |
